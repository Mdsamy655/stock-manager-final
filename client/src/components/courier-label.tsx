...
export default function CourierLabel({
  ...
  const [companyName, setCompanyName] = useState(
    () => localStorage.getItem("label_company_name") || "",
  );
  const [companyPhone, setCompanyPhone] = useState(
    () => localStorage.getItem("label_company_phone") || "",
  );
  ...
  const buildPrintHtml = () => {
    ...
    const qrSvg = sale.consignmentId
      ? generateQrSvgString(sale.consignmentId, 140)
      : "";
    const barcodeSvg = sale.consignmentId
      ? generateBarcodeSvgString(sale.consignmentId, 70, 2.5)
      : "";
  ...
  const handleDownloadPDF = async () => {
    ...
    container.style.cssText =
      "position:absolute;left:-9999px;top:0;width:210mm;background:#fff;padding:0;";
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex gap-2 justify-end mb-3 items-center">
          ...
          <Button
            ...
            data-testid="button-download-label-pdf"
          >
        ...
        <div className="border rounded-lg bg-white p-3">
          <p className="text-xs text-muted-foreground mb-2 text-center">
            Label Preview (1 label per A4 page)
          </p>
          <div ref={labelRef}>
            <div
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  data-testid="text-label-parcel-id"
                >
                  {trackingNumber}
                </div>
              </div>
              ...
              <div
                style={{ display: "flex", borderBottom: "1.5px solid #ddd" }}
              >
                  ...
                  >
                    ...
                    {companyName && (
                      <div
                        ...
                        data-testid="text-label-sender-name"
                      >
                        {companyName}
                      </div>
                    )}
                ...
                <div style={{ flex: 1, padding: "6px 12px" }}>
                  ...
                  <div
                    ...
                    data-testid="text-label-customer-name"
                  >
                  ...
                  <div
                    ...
                    data-testid="text-label-customer-phone"
                  >
                    {sale.customerPhone || ""}
                  </div>
                  <div
                    ...
                    data-testid="text-label-customer-address"
                  >
              ...
              >
                ...
                <span
                  style={{ color: "#dc2626" }}
                  data-testid="text-label-cod-amount"
                >
